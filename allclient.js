...
invoke : 		function(param,onok,onerr){ 
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	request.txId = tx_id;
	console.log("### invoke prepared request:");
	console.log(request);
    ...
    console.log("invoke: receieved request for payload:" + param);
...
query  : 		function(param,onok , onerr){ 
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	var request = JSON.parse(param);
	console.log("### query prepared request:");
	console.log(request);
